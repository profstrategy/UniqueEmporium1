...
export interface ProductDetails extends Product {
  ...
  modelPath?: string; // Added modelPath field
}
...
export const mockProducts: ProductDetails[] = [
  {
    ...
    modelPath: "/models/zenbook_pro_14_oled.glb", // Added model path
  },
  {
    id: "surface-pro-9",
    name: "Surface Pro 9",
    ...
    modelPath: "/models/surface_pro_9.glb", // Placeholder model path
  },
  {
    id: "echo-dot-5th-gen",
    ...
    modelPath: "/models/echo_dot_5th_gen.glb", // Placeholder model path
  },
  {
    ...
    relatedProducts: ["ergogrip-wireless-mouse"],
    modelPath: "/models/ergofit_wireless_keyboard.glb", // Placeholder model path
  },
  {
    id: "prodisplay-xdr",
    name: "ProDisplay XDR",
    ...
    modelPath: "/models/prodisplay_xdr.glb", // Placeholder model path
  },
  {
    ...
    modelPath: "/models/gaming_beast_desktop_pc.glb", // Placeholder model path
  },
  {
    ...
    modelPath: "/models/soundwave_headphones.glb", // Placeholder model path
  },
  {
    ...
    relatedProducts: ["zenbook-pro-14-oled"],
    modelPath: "/models/ultrafast_1tb_external_ssd.glb", // Placeholder model path
  },
  {
    ...
    modelPath: "/models/smarthome_hub_pro.glb", // Placeholder model path
  },
  {
    ...
    modelPath: "/models/powercharge_100w_gan_charger.glb", // Placeholder model path
  },
  {
    ...
    modelPath: "/models/visionpro_4k_webcam.glb", // Placeholder model path
  },
  {
    id: "swiftbook-air-13",
    ...
    modelPath: "/models/swiftbook_air_13.glb", // Placeholder model path
  },
  {
    ...
    modelPath: "/models/galaxy_tab_s9_ultra.glb", // Placeholder model path
  },
  {
    ...
    modelPath: "/models/officemaster_all_in_one_pc.glb", // Placeholder model path
  },
  {
    ...
    relatedProducts: ["gaming-beast-desktop-pc"],
    modelPath: "/models/gaming_pro_wireless_mouse.glb", // Placeholder model path
  },
  {
    ...
    modelPath: "/models/smartwatch_xtreme.glb", // Placeholder model path
  },
  {
    ...
    relatedProducts: ["smarthome-hub-pro"],
    modelPath: "/models/portable_projector_mini.glb", // Placeholder model path
  },
  {
    id: "cyberbook-pro-16",
    ...
    relatedProducts: ["zenbook-pro-14-oled"],
    modelPath: "/models/cyberbook_pro_16.glb", // Placeholder model path
  },
  {
    ...
    relatedProducts: ["ultrafast-1tb-external-ssd"],
    modelPath: "/models/homeserver_nas_4_bay.glb", // Placeholder model path
  },
  {
    ...
    relatedProducts: ["ergofit-wireless-keyboard"],
    modelPath: "/models/smartdesk_standing_desk.glb", // Placeholder model path
  },
];
